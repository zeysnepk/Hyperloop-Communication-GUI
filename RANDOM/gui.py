...
"background-color: qconicalgradient(cx:0.5, cy:0.5, angle:90, stop:0.319 rgba(255, 255, 255, 0), stop:0.320 rgba(69, 150, 255, 255));\n"
"border-radius:90px\n"
"}")
...
"    background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0.400 rgba(69, 150, 255, 255), stop:0.401 rgba(255, 255, 255, 0));\n"
"}")
...
"    background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0.500 rgba(69, 150, 255, 255), stop:0.501 rgba(255, 255, 255, 0));\n"
"}")
...
"color: rgb(122, 129, 255);")
        ...
        self.label_lane = QtWidgets.QLabel(self.frame_2)
        self.label_lane.setStyleSheet("font:700 30pt \"Chakra Petch\";\n"
"color: rgb(122, 129, 255);")
        self.label_lane.setAlignment(QtCore.Qt.AlignCenter)
        self.label_lane.setObjectName("label_lane")
        self.verticalLayout_5.addWidget(self.label_lane)
...
"color: rgb(255, 38, 0);")
        ...
        self.label_battery = QtWidgets.QLabel(self.frame_3)
        self.label_battery.setStyleSheet("font:700 30pt \"Chakra Petch\";\n"
"color: rgb(255, 38, 0);")
        self.label_battery.setAlignment(QtCore.Qt.AlignCenter)
        self.label_battery.setObjectName("label_battery")
        self.verticalLayout_6.addWidget(self.label_battery)
...
"CONSUMPTION"))
        self.label_watt.setText(_translate("MainWindow", "560 W"))
...
"(second)"))
        ...
        self.label_16.setText(_translate("MainWindow", "Lane Count"))
        self.label_lane.setText(_translate("MainWindow", "0"))
        self.label_18.setText(_translate("MainWindow", "Battery Status"))
        self.label_battery.setText(_translate("MainWindow", "0"))
        self.label_20.setText(_translate("MainWindow", "Data Acquisition Rate"))
        self.label_data_speed.setText(_translate("MainWindow", "0"))
        self.label_22.setText(_translate("MainWindow", "Vehicle Status"))
        self.label_stat.setText(_translate("MainWindow", "OFF"))
        self.pushButton_start.setText(_translate("MainWindow", "START"))
        self.pushButton_stop.setText(_translate("MainWindow", "STOP"))
        self.pushButton_go.setText(_translate("MainWindow", "FORWARD"))
        self.pushButton_back.setText(_translate("MainWindow", "BACKWARD"))
        self.label_13.setText(_translate("MainWindow", "POSITION(m)"))
        self.label_position.setText(_translate("MainWindow", "X : \n"
"Y :\n"
"Z :"))
        self.label_14.setText(_translate("MainWindow", "VELOCITY(m/s)"))
        self.label_speed.setText(_translate("MainWindow", "X :\n"
"Y :\n"
"Z :"))
        self.label_26.setText(_translate("MainWindow", "ACCELERATION(m/s²)"))
        self.label_acc.setText(_translate("MainWindow", "X :\n"
"Y :\n"
"Z :"))
        self.label_28.setText(_translate("MainWindow", "ORIENTATION(°)"))
        self.label_ori.setText(_translate("MainWindow", "Roll :\n"
"Pitch :\n"
"Yaw :"))
        self.label_30.setText(_translate("MainWindow", "TEMPERATURE(°C)"))
        self.label_temp.setText(_translate("MainWindow", "T1 :\n"
"T2 :"))
        self.label_32.setText(_translate("MainWindow", "POWER CONSUMPTION(Watt)"))
        self.label_watt_2.setText(_translate("MainWindow", "560"))
import pic_rc
